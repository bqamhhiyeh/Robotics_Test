...
"""autogenerated by genpy from teleoperation/Status.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2d4i4d2i().pack(_x.battery_level, _x.current, _x.ADC1, _x.ADC2, _x.ADC3, _x.ADC4, _x.speed_front_left, _x.speed_front_right, _x.odometry_left, _x.odometry_right, _x.version, _x.relay1))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.battery_level, _x.current, _x.ADC1, _x.ADC2, _x.ADC3, _x.ADC4, _x.speed_front_left, _x.speed_front_right, _x.odometry_left, _x.odometry_right, _x.version, _x.relay1,) = _get_struct_2d4i4d2i().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2d4i4d2i = None
def _get_struct_2d4i4d2i():
    global _struct_2d4i4d2i
    if _struct_2d4i4d2i is None:
        _struct_2d4i4d2i = struct.Struct("<2d4i4d2i")
    return _struct_2d4i4d2i
